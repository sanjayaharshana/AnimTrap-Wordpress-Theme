        ...
        <div class="col-sm-4">
            <div class="<?php echo esc_attr( get_option('select_animation') ); ?>">            
                <div class="" data-animscroll="fade-up">
                    ...
                    <img class="img-responsive" src="<?php echo wp_get_attachment_url(get_theme_mod('midlayer-image1')) ?>" alt="SourceWallet"  >
                    </a>
                </div>           
            </div>
        </div>
         <div class="col-sm-4">
            <div class="<?php echo esc_attr( get_option('select_animation') ); ?>">
                <div class="" data-animscroll="fade-up">
                    ...
                    <img class="img-responsive" src="<?php echo wp_get_attachment_url(get_theme_mod('midlayer-image2')) ?>" alt="SourceWallet"  >
                    </a>
                </div>
            </div>
        </div>
         <div class="col-sm-4">
            <div class="<?php echo esc_attr( get_option('select_animation') ); ?>">
                <div class="" data-animscroll="fade-up">
                    ...
                    <img class="img-responsive" src="<?php echo wp_get_attachment_url(get_theme_mod('midlayer-image3')) ?>" alt="SourceWallet"  >
                    </a>
                </div>
            </div>
        </div>
